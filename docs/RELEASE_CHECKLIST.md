...
Use simple version labels for public communication. For this release, use `1.1 beta 4` in prose and `1.1b4` in Python/package metadata.


Set these values before starting the checklist:

- Release version: `1.1b4`.
- Git tag: `v1.1b4`.
- Portable zip name: `HappyMeasure-1.1b4-windows-portable.zip`.
